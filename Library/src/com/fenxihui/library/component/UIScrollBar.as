package com.fenxihui.library.component
{
	...
	{		
		 ...
		 * @playerversion Flash 9.0.28.0
		 */
		override public function set scrollPosition(scrollPosition:Number):void {
			super.scrollPosition=scrollPosition;
